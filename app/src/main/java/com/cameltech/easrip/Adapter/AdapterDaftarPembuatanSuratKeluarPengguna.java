...
public class AdapterDaftarPembuatanSuratKeluarPengguna extends RecyclerView.Adapter<AdapterDaftarPembuatanSuratKeluarPengguna.ViewHolder> {
    ...
    public AdapterDaftarPembuatanSuratKeluarPengguna(Context ctx, ArrayList<PembuatanSuratKeluar> suratKeluars){
        context = ctx;
